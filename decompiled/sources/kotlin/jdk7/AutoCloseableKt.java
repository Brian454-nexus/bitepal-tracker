...
public final class AutoCloseableKt {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final <T extends AutoCloseable, R> R use(T t6, Function1<? super T, ? extends R> block) {
