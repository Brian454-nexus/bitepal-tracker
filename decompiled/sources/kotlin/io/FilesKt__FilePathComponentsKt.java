...
public class FilesKt__FilePathComponentsKt {
    ...
    private static final int getRootLength$FilesKt__FilePathComponentsKt(String str) {
        ...
        int indexOf$default2 = StringsKt.indexOf$default(str, c6, 0, false, 4, (Object) null);
        if (indexOf$default2 == 0) {
            if (str.length() <= 1 || str.charAt(1) != c6 || (indexOf$default = StringsKt.indexOf$default(str, c6, 2, false, 4, (Object) null)) < 0) {
                return 1;
            }
            int indexOf$default3 = StringsKt.indexOf$default(str, c6, indexOf$default + 1, false, 4, (Object) null);
        ...
        if (indexOf$default2 == -1 && StringsKt.endsWith$default(str, ':', false, 2, (Object) null)) {
            return str.length();
        }
        return 0;
    }
    ...
    @NotNull
    public static final File subPath(@NotNull File file, int i6, int i7) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        return toComponents(file).subPath(i6, i7);
    }
    ...
    public static final FilePathComponents toComponents(@NotNull File file) {
        ...
        if (substring2.length() == 0) {
            ...
            List split$default = StringsKt.split$default(substring2, new char[]{File.separatorChar}, false, 0, 6, (Object) null);
