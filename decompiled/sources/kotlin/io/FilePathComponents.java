...
public final /* data */ class FilePathComponents {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ FilePathComponents copy$default(FilePathComponents filePathComponents, File file, List list, int i6, Object obj) {
        if ((i6 & 1) != 0) {
    ...
    public final File subPath(int beginIndex, int endIndex) {
        ...
        return new File(CollectionsKt.joinToString$default(subList, separator, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 62, (Object) null));
    }
