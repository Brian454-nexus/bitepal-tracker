...
public final class FileTreeWalk implements Sequence<File> {
    ...
    public final class FileTreeWalkIterator extends AbstractIterator<File> {
        ...
        private final DirectoryState directoryState(File root) {
            int i6 = WhenMappings.$EnumSwitchMapping$0[FileTreeWalk.this.direction.ordinal()];
            if (i6 == 1) {
    ...
    private FileTreeWalk(File file, FileWalkDirection fileWalkDirection, Function1<? super File, Boolean> function1, Function1<? super File, Unit> function12, Function2<? super File, ? super IOException, Unit> function2, int i6) {
        this.start = file;
    ...
    public final FileTreeWalk maxDepth(int depth) {
        ...
        throw new IllegalArgumentException("depth must be positive, but was " + depth + b.f11260a);
    }
    ...
    public /* synthetic */ FileTreeWalk(File file, FileWalkDirection fileWalkDirection, Function1 function1, Function1 function12, Function2 function2, int i6, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i7 & 2) != 0 ? FileWalkDirection.TOP_DOWN : fileWalkDirection, function1, function12, function2, (i7 & 32) != 0 ? IntCompanionObject.MAX_VALUE : i6);
    }
    ...
    public /* synthetic */ FileTreeWalk(File file, FileWalkDirection fileWalkDirection, int i6, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i6 & 2) != 0 ? FileWalkDirection.TOP_DOWN : fileWalkDirection);
    }
}
