...
public final class ConsoleKt {
    ...
    @InlineOnly
    private static final void print(int i6) {
        System.out.print(i6);
    }

    @InlineOnly
    private static final void println(int i6) {
        System.out.println(i6);
    }

    @InlineOnly
    private static final void print(long j6) {
        System.out.print(j6);
    }

    @InlineOnly
    private static final void println(long j6) {
        System.out.println(j6);
    }

    @InlineOnly
    private static final void print(byte b6) {
        System.out.print(Byte.valueOf(b6));
    }

    @InlineOnly
    private static final void println(byte b6) {
        System.out.println(Byte.valueOf(b6));
    }

    @InlineOnly
    private static final void print(short s6) {
        System.out.print(Short.valueOf(s6));
    }

    @InlineOnly
    private static final void println(short s6) {
        System.out.println(Short.valueOf(s6));
    }

    @InlineOnly
    private static final void print(char c6) {
        System.out.print(c6);
    }

    @InlineOnly
    private static final void println(char c6) {
        System.out.println(c6);
    }

    @InlineOnly
    private static final void print(boolean z6) {
        System.out.print(z6);
    }

    @InlineOnly
    private static final void println(boolean z6) {
        System.out.println(z6);
    }

    @InlineOnly
    private static final void print(float f6) {
        System.out.print(f6);
    }

    @InlineOnly
    private static final void println(float f6) {
        System.out.println(f6);
    }

    @InlineOnly
    private static final void print(double d6) {
        System.out.print(d6);
    }

    @InlineOnly
    private static final void println(double d6) {
