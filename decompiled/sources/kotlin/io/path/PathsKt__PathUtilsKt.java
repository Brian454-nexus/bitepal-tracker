...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    @InlineOnly
    private static final Path copyTo(Path path, Path target, boolean z6) {
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z6, int i6, Object obj) {
        if ((i6 & 2) != 0) {
            z6 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ Path createTempDirectory$default(String str, FileAttribute[] attributes, int i6, Object obj) {
        if ((i6 & 1) != 0) {
            str = null;
        }
        Intrinsics.checkNotNullParameter(attributes, "attributes");
    ...
    public static /* synthetic */ Path createTempFile$default(String str, String str2, FileAttribute[] attributes, int i6, Object obj) {
        if ((i6 & 1) != 0) {
            str = null;
        }
        if ((i6 & 2) != 0) {
    ...
    public static final Void fileAttributeViewNotAvailable(@NotNull Path path, @NotNull Class<?> attributeViewClass) {
        ...
        throw new UnsupportedOperationException("The desired attribute view type " + attributeViewClass + " is not available for the file " + path + com.amazon.a.a.o.c.a.b.f11260a);
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        V v6 = (V) Files.getFileAttributeView(path, FileAttributeView.class, (LinkOption[]) Arrays.copyOf(options, options.length));
        if (v6 != null) {
            return v6;
        }
        Intrinsics.reifiedOperationMarker(4, "V");
    ...
    public static /* synthetic */ void forEachDirectoryEntry$default(Path path, String glob, Function1 action, int i6, Object obj) {
        if ((i6 & 1) != 0) {
            glob = "*";
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static final String getExtension(@NotNull Path path) {
        ...
        return (fileName == null || (obj = fileName.toString()) == null || (substringAfterLast = StringsKt.substringAfterLast(obj, com.amazon.a.a.o.c.a.b.f11260a, "")) == null) ? "" : substringAfterLast;
    }
    ...
    public static /* synthetic */ Path moveTo$default(Path path, Path target, boolean z6, int i6, Object obj) {
        if ((i6 & 2) != 0) {
            z6 = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i6, Object obj) {
        if ((i6 & 1) != 0) {
            glob = "*";
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    @SinceKotlin(version = "1.7")
    @ExperimentalPathApi
    public static final void visitFileTree(@NotNull Path path, @NotNull FileVisitor<Path> visitor, int i6, boolean z6) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(visitor, "visitor");
        Files.walkFileTree(path, z6 ? SetsKt.setOf(FileVisitOption.FOLLOW_LINKS) : SetsKt.emptySet(), i6, visitor);
    }
    ...
    @WasExperimental(markerClass = {ExperimentalPathApi.class})
    @InlineOnly
    private static final Path moveTo(Path path, Path target, boolean z6) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(target, "target");
        CopyOption[] copyOptionArr = z6 ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path move = Files.move(path, target, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
    ...
    public static /* synthetic */ void visitFileTree$default(Path path, int i6, boolean z6, Function1 function1, int i7, Object obj) {
        if ((i7 & 1) != 0) {
            i6 = IntCompanionObject.MAX_VALUE;
        }
        if ((i7 & 2) != 0) {
        ...
        visitFileTree(path, i6, z6, (Function1<? super FileVisitorBuilder, Unit>) function1);
    }
    ...
    @SinceKotlin(version = "1.7")
    @ExperimentalPathApi
    public static final void visitFileTree(@NotNull Path path, int i6, boolean z6, @NotNull Function1<? super FileVisitorBuilder, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        visitFileTree(path, fileVisitor(builderAction), i6, z6);
    }
}
