...
public final class ExceptionsCollector {
    ...
    public ExceptionsCollector(int i6) {
        this.limit = i6;
        this.collectedExceptions = new ArrayList();
    }

    public /* synthetic */ ExceptionsCollector(int i6, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? 64 : i6);
    }
}
