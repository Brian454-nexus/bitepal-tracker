...
public class ReflectionFactory {
    ...
    @SinceKotlin(version = "1.4")
    public KType typeOf(KClassifier kClassifier, List<KTypeProjection> list, boolean z6) {
        return new TypeReference(kClassifier, list, z6);
    }

    @SinceKotlin(version = "1.4")
    public KTypeParameter typeParameter(Object obj, String str, KVariance kVariance, boolean z6) {
