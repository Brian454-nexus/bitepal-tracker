...
public class TypeIntrinsics {
    ...
    public static boolean isFunctionOfArity(Object obj, int i6) {
        return (obj instanceof Function) && getFunctionArity(obj) == i6;
    }
    ...
    private static <T extends Throwable> T sanitizeStackTrace(T t6) {
        return (T) Intrinsics.sanitizeStackTrace(t6, TypeIntrinsics.class.getName());
    }
    ...
    public static Object beforeCheckcastToFunctionOfArity(Object obj, int i6, String str) {
        if (obj != null && !isFunctionOfArity(obj, i6)) {
            throwCce(str);
        }
        return obj;
