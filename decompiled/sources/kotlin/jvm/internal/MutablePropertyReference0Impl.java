...
public class MutablePropertyReference0Impl extends MutablePropertyReference0 {
    ...
    public MutablePropertyReference0Impl(Class cls, String str, String str2, int i6) {
        super(CallableReference.NO_RECEIVER, cls, str, str2, i6);
    }

    @SinceKotlin(version = "1.4")
    public MutablePropertyReference0Impl(Object obj, Class cls, String str, String str2, int i6) {
