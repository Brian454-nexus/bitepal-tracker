...
public final class TypesJVMKt {
    ...
    public static final Type computeJavaType(KType kType, boolean z6) {
        ...
        Class javaObjectType = z6 ? JvmClassMappingKt.getJavaObjectType(kClass) : JvmClassMappingKt.getJavaClass(kClass);
        ...
        int i6 = variance == null ? -1 : WhenMappings.$EnumSwitchMapping$0[variance.ordinal()];
        if (i6 == -1 || i6 == 1) {
            return javaObjectType;
        }
        if (i6 != 2 && i6 != 3) {
    ...
    public static /* synthetic */ Type computeJavaType$default(KType kType, boolean z6, int i6, Object obj) {
        if ((i6 & 1) != 0) {
            z6 = false;
        }
        return computeJavaType(kType, z6);
    }
    ...
    private static final Type getJavaType(KTypeProjection kTypeProjection) {
        ...
        KType type = kTypeProjection.getType();
        Intrinsics.checkNotNull(type);
        int i6 = WhenMappings.$EnumSwitchMapping$0[variance.ordinal()];
        if (i6 == 1) {
