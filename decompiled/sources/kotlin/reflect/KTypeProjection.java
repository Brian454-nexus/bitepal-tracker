...
public final /* data */ class KTypeProjection {
    ...
    public static /* synthetic */ KTypeProjection copy$default(KTypeProjection kTypeProjection, KVariance kVariance, KType kType, int i6, Object obj) {
        if ((i6 & 1) != 0) {
    ...
    public String toString() {
        KVariance kVariance = this.variance;
        int i6 = kVariance == null ? -1 : WhenMappings.$EnumSwitchMapping$0[kVariance.ordinal()];
        if (i6 == -1) {
            return "*";
        }
        if (i6 == 1) {
