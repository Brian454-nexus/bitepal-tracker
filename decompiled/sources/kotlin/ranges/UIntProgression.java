...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m25fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.toString-impl(this.first));
            sb.append("..");
            sb.append((Object) UInt.toString-impl(this.last));
            sb.append(" step ");
            i6 = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private UIntProgression(int i6, int i7, int i8) {
        ...
        if (i8 != Integer.MIN_VALUE) {
            this.first = i6;
            this.last = UProgressionUtilKt.getProgressionLastElement-Nkh28Cs(i6, i7, i8);
            this.step = i8;
            return;
        }
