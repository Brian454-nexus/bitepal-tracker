...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    public /* synthetic */ ULongProgressionIterator(long j6, long j7, long j8, DefaultConstructorMarker defaultConstructorMarker) {
        this(j6, j7, j8);
    }
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.box-impl(m35nextsVKNKU());
    }

    /* renamed from: next-s-VKNKU, reason: not valid java name */
    public long m35nextsVKNKU() {
        long j6 = this.next;
        if (j6 != this.finalElement) {
            this.next = ULong.constructor-impl(this.step + j6);
            return j6;
        }
        if (!this.hasNext) {
    ...
    private ULongProgressionIterator(long j6, long j7, long j8) {
        ...
        this.hasNext = z6;
        this.step = ULong.constructor-impl(j8);
