...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* synthetic */ UIntProgressionIterator(int i6, int i7, int i8, DefaultConstructorMarker defaultConstructorMarker) {
        this(i6, i7, i8);
    }
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.box-impl(m26nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA, reason: not valid java name */
    public int m26nextpVg5ArA() {
        int i6 = this.next;
        if (i6 != this.finalElement) {
            this.next = UInt.constructor-impl(this.step + i6);
            return i6;
        }
        if (!this.hasNext) {
    ...
    private UIntProgressionIterator(int i6, int i7, int i8) {
        ...
        this.hasNext = z6;
        this.step = UInt.constructor-impl(i8);
        this.next = this.hasNext ? i6 : i7;
    }
}
