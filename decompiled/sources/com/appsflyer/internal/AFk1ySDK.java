...
public final class AFk1ySDK {
    private static int getMediationNetwork(int i6, int[][] iArr) {
    ...
    public static void getRevenue(int i6, int i7, boolean z6, int i8, int[] iArr, int[][] iArr2, int[] iArr3) {
        if (!z6) {
        ...
        while (i9 < i8) {
            int i10 = i6 ^ iArr[i9];
            int mediationNetwork = i7 ^ getMediationNetwork(i10, iArr2);
            i9++;
            i7 = i10;
            i6 = mediationNetwork;
        }
