...
public final class AFk1uSDK {
    ...
    static {
        ...
        for (int i8 = 0; i8 < 256; i8++) {
            int i9 = component3[i8] & 255;
            getRevenue[i9] = (byte) i8;
            int i10 = i8 << 1;
            if (i10 >= 256) {
                i10 ^= 283;
            }
            ...
            getMonetizationNetwork[i9] = i14;
            getCurrencyIso4217Code[i9] = (i14 >>> 8) | (i14 << 24);
            getMediationNetwork[i9] = (i14 >>> 16) | (i14 << 16);
            AFAdRevenueData[i9] = (i14 << 8) | (i14 >>> 24);
        }
        ...
        for (int i16 = 1; i16 < 10; i16++) {
            ...
            component1[i16] = i15 << 24;
        }
    }

    public static int[] getMediationNetwork(byte[] bArr, int i6) {
        if (bArr.length != 16) {
        ...
        while (i13 < i8) {
            ...
            if (i14 == 0) {
                ...
                i16 = ((bArr2[i16 >>> 24] & 255) | (((bArr2[(i16 >>> 16) & 255] << 24) | ((bArr2[(i16 >>> 8) & 255] & 255) << 16)) | ((bArr2[i16 & 255] & 255) << 8))) ^ component1[i15];
                i14 = 4;
                i15++;
            }
    ...
    public static byte[][] getMonetizationNetwork(int i6) {
