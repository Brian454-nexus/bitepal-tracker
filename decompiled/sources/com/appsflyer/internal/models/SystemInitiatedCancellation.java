...
public final class SystemInitiatedCancellation {
    ...
    public static final class Companion implements Deserialize<SystemInitiatedCancellation> {
        ...
        @NotNull
        public final SystemInitiatedCancellation fromJson(@NotNull JSONObject p02) {
    ...
    public final boolean equals(@Nullable Object p02) {
        ...
        return Intrinsics.areEqual(SystemInitiatedCancellation.class, p02 != null ? p02.getClass() : null);
    }
