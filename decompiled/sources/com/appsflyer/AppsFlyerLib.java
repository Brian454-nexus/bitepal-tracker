...
public abstract class AppsFlyerLib {
    ...
    public abstract void anonymizeUser(boolean z6);

    public abstract void appendParametersToDeepLinkingURL(String str, Map<String, String> map);

    public abstract void enableFacebookDeferredApplinks(boolean z6);

    public abstract void enableTCFDataCollection(boolean z6);
    ...
    public abstract void setCollectAndroidID(boolean z6);

    public abstract void setCollectIMEI(boolean z6);

    @Deprecated
    public abstract void setCollectOaid(boolean z6);
    ...
    public abstract void setDebugLog(boolean z6);

    public abstract void setDisableAdvertisingIdentifiers(boolean z6);

    public abstract void setDisableNetworkData(boolean z6);
    ...
    public abstract void setIsUpdate(boolean z6);
    ...
    public abstract void stop(boolean z6, Context context);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener);

    public abstract void subscribeForDeepLink(DeepLinkListener deepLinkListener, long j6);
    ...
    public abstract void waitForCustomerUserId(boolean z6);
}
